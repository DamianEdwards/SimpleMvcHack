...
namespace Microsoft.AspNetCore.Mvc
{
    ...
    public abstract class ViewPage<TModel> : ViewPage
    {
        ...
        public TModel Model
        {
            get
            {
                return ViewData?.Model == null ? default(TModel) : (TModel)ViewData.Model;
            }
        }
    ...
    [Route("/*")]
    [Controller]
    public abstract class ViewPage : RazorPage, IActionFilter, IAsyncActionFilter, IDisposable
    {
        ...
        {
            // TODO: Figure out how to default this to returning this
        ...
        {
            // TODO: Figure out how to default to returning "this" as the view
